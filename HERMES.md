...
如果你的Hermes环境支持读取仓库文件，把本仓库加入Agent工作区后，让它优先读取`AGENTS.md`。需要句式和示例时，读取`human-social-copy/references/patterns.md`。需要更完整的开头钩子模型时，读取`human-social-copy/references/adaptive-hooks.md`。
